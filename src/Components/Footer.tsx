      ...
      <footer className="text-center lg:text-left bg-gray-100 text-gray-800">
        <div className="mx-6 py-10 text-center md:text-left">
          ...
          "
              ...
              <p>
                I'd love working as a Software Engineer for Vertrical GmbH. I
                believe that I have found a place to show off my professional
                skills and work toward a shinny future of Vertrical.
              </p>
            </div>
            <div className="">
              <h6 className="uppercase font-serif mb-4 flex justify-center md:justify-start">
                My Current Lessons
              </h6>
              <p className="mb-4">
